#!/usr/bin/env python3
"""Pair bounded static/dynamic responses for judge evaluation."""
...
def main() -> int:
    ...
    for prompt_id, variants in sorted(by_prompt.items()):
        ...
        pairs.append(
            {
                "pair_id": f"l19-{prompt_id}",
                "source": "stage19_bounded_generation_uf_test_prompts",
                ...
                "provenance": {
                    ...
                    "note": "Bounded local fallback evaluation; not an AlpacaEval benchmark result.",
                },
            }
        )
